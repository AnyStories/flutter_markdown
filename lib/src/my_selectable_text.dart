...
import 'package:flutter_markdown/src/editable.dart';
...
class _MySelectableTextSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _MySelectableTextSelectionGestureDetectorBuilder({
    required _MySelectableTextState state,
  }) : _state = state,
        super(delegate: state);

  final _MySelectableTextState _state;

  @override
  void onForcePressStart(ForcePressDetails details) {
    debugPrint("MySelectableText--onForcePressStart");
  ...
  void onSingleLongTapMoveUpdate(LongPressMoveUpdateDetails details) {
    debugPrint("MySelectableText--onSingleLongTapMoveUpdate");
  ...
  void onSingleTapUp(TapUpDetails details) {
    debugPrint("MySelectableText--onSingleTapUp");
  ...
  void onSingleLongTapStart(LongPressStartDetails details) {
    debugPrint("MySelectableText--onSingleLongTapStart");
    if (delegate.selectionEnabled) {
      renderEditable.selection = TextSelection(baseOffset: 0, extentOffset: editableText.textEditingValue.text.length);
...
///
/// The [MySelectableText] widget displays a string of text with a single style.
...
/// {@end-tool}
///
/// Using the [MySelectableText.rich] constructor, the [MySelectableText] widget can
...
/// ## Interactivity
///
/// To make [MySelectableText] react to touch events, use callback [onTap] to achieve
...
class MySelectableText extends StatefulWidget {
  ...
  const MySelectableText(
      String this.data, {
        ...
        assert(
        data != null,
        'A non-null String must be provided to a MySelectableText widget.',
        ),
        textSpan = null,
        toolbarOptions = toolbarOptions ??
  ...
  const MySelectableText.rich(
      TextSpan this.textSpan, {
        ...
        assert(
        textSpan != null,
        'A non-null TextSpan must be provided to a MySelectableText.rich widget.',
        ),
        data = null,
        toolbarOptions = toolbarOptions ??
            const ToolbarOptions(
...
class _MySelectableTextState extends State<MySelectableText> with AutomaticKeepAliveClientMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  late _MySelectableTextSelectionGestureDetectorBuilder _selectionGestureDetectorBuilder;
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder = _MySelectableTextSelectionGestureDetectorBuilder(state: this);
  ...
  @override
  void didUpdateWidget(MySelectableText oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    }(), 'MySelectableText only supports TextSpan; Other type of InlineSpan is not allowed');
